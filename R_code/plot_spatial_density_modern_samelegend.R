...
ggsave(plot=spd, 
       filename='spatial_density_spring_samelegend.png', 
...
ggsave(plot=spd, 
       filename='spatial_density_fall_samelegend.png', 
       height=8.5, width=11, units='in')
...
fZlim = range(grid$y, na.rm=T)

Zlim = c(min(c(fZlim[1], sZlim[1])),
         max(c(fZlim[2], sZlim[2])))
...
ggsave(plot=tspd.f,
       filename='summed_spatial_density_fall_singlelegend.png',
...
ggsave(plot=tspd.s,
       filename='summed_spatial_density_spring_singlelegend.png',
       height=4, width=3.5, units = 'in')
