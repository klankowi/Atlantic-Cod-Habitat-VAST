...
cog.c <- read.csv(here('VAST_runs/medium/GMRF/OFF/COG.csv'))
cog.c$Model <- 'No GMRF'
cog.f<- read.csv(here('VAST_runs/medium/GMRF/ON/COG.csv'))
cog.f$Model <- 'GMRF'
cog <- rbind(cog.c, cog.f)

re.c <- read.csv(here('VAST_runs/medium/GMRF/OFF/RangeEdges.csv'))
re.c$Model <- 'No GMRF'
re.f<- read.csv(here('VAST_runs/medium/GMRF/ON/RangeEdges.csv'))
re.f$Model <- 'GMRF'
re <- rbind(re.c, re.f)

ind.c <- read.csv(here('VAST_runs/medium/GMRF/OFF/Index.csv'))
ind.c$Model <- 'No GMRF'
ind.f<- read.csv(here('VAST_runs/medium/GMRF/ON/Index.csv'))
ind.f$Model <- 'GMRF'
ind <- rbind(ind.c, ind.f)

arrocc.c <- read.csv(here('VAST_runs/medium/GMRF/OFF/AreaOcc.csv'))
arrocc.c$Model <- 'No GMRF'
arrocc.f<- read.csv(here('VAST_runs/medium/GMRF/ON/AreaOcc.csv'))
arrocc.f$Model <- 'GMRF'
...
setwd(here('VAST_runs/medium/GMRF'))
# Save plots
