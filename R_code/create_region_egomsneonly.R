...
# Pull SNE, WGOM
shp <- subset(shpsplit, STRATA %in% c('SNE', 'WGOM'))
...
region <- subset(region, STRATA == 'ALL')
saveRDS(region, file = here("Data/VAST_input/VAST_regions/user_region_egomsneonly.rds"))
