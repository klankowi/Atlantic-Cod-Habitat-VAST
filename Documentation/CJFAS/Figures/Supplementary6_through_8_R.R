...
ggsave(here('Documentation/CJFAS/Figures/Supplementary/Supp Fig 8a.pdf'),
       supfiga,
       height=10, width=8.5, units='in',
       dpi = 300)

ggsave('C:/Users/klankowicz/Box/Katie Lankowicz/Data_Analysis/Cod/Writings/CJFAS/Figures/Supplementary/Supp Fig 8a.pdf',
       supfiga,
       height=10, width=8.5, units='in',
       dpi = 300)
...
ggsave(here('Documentation/CJFAS/Figures/Supplementary/Supp Fig 8b.pdf'),
       supfigb,
       height=10, width=8.5, units='in',
       dpi = 300)

ggsave('C:/Users/klankowicz/Box/Katie Lankowicz/Data_Analysis/Cod/Writings/CJFAS/Figures/Supplementary/Supp Fig 8b.pdf',
       supfigb,
       height=10, width=8.5, units='in',
       dpi = 300)
