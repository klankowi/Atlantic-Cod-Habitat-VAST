...
# Load data
load(here('VAST_runs/large/Overall_BC/ALL_Catchability2/Overall_BC_largecod_allstrat_natsplin_fsON_ALL_SVC.RData'))
setwd(here("VAST_runs/large/Overall_BC/ALL_Catchability2"))
...
ggsave(here('Documentation/CJFAS/Figures/Supplementary/Supp Fig 4a.pdf'),
       supfig1a,
       height=8.5, width=11, units='in',
       dpi = 300)

ggsave(here('Documentation/CJFAS/Figures/Supplementary/Supp Fig 4b.pdf'),
       supfig1b,
       height=8.5, width=11, units='in',
       dpi = 300)

ggsave("C:/Users/klankowicz/Box/Katie Lankowicz/Data_Analysis/Cod/Writings/CJFAS/Figures/Supplementary/Supp Fig 4a.pdf",
       supfig1a,
       height=8.5, width=11, units='in',
       dpi = 300)

ggsave("C:/Users/klankowicz/Box/Katie Lankowicz/Data_Analysis/Cod/Writings/CJFAS/Figures/Supplementary/Supp Fig 4b.pdf",
       supfig1b,
       height=8.5, width=11, units='in',
       dpi = 300)
