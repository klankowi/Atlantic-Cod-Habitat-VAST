...
for(i in 1:nrow(keep)){
  test <- sfdep::ellipse(x = center$x, y = center$y,
...
# Save local
ggsave(here('Documentation/CJFAS/Figures/Supplementary/Supp Fig 5.pdf'),
       supfig4,
       height=(18.2 * 0.4), width=18.2, units='cm',
       dpi = 600)

# Save to collaborators
ggsave("C:/Users/klankowicz/Box/Katie Lankowicz/Data_Analysis/Cod/Writings/CJFAS/Figures/Supplementary/Supp Fig 5.pdf",
       supfig4,
       height=(18.2 * 0.4), width=18.2, units='cm',
       dpi = 600)
