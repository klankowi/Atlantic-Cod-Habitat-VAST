### Make Figure 3, stock-, size-, and season-specific COG maps ####
#### CJFAS 2024 ####
rm(list=ls())
...
# Label facets
fig3 <- tag_facet2(fig3, open='', close='', col='gray30')
...
ggsave("C:/Users/klankowicz/Box/Katie Lankowicz/Data_Analysis/Cod/Writings/CJFAS/Figures/Fig 3.pdf",
      fig3,
      height=(18.2 * 0.75), width=18.2, units='cm',
      dpi = 600)