...
setwd(here("VAST_runs/medium/Overall_BC/ALL_Catchability2"))
...
ggsave(here('Documentation/CJFAS/Figures/Supplementary/Supp Fig 3a.pdf'),
       supfig1a,
       height=8.5, width=11, units='in',
       dpi = 300)

ggsave(here('Documentation/CJFAS/Figures/Supplementary/Supp Fig 3b.pdf'),
       supfig1b,
       height=8.5, width=11, units='in',
       dpi = 300)
